...
import 'package:bakeryforyou/adminproduct.dart';
import 'package:bakeryforyou/user.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  String server = "https://seriouslaa.com/bakery";
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              if (widget.user.email == "unregistered@bakery.com") {
                Toast.show("Please register to use this function", context,
                    duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                return;
              } else if (widget.user.email == "admin@bakery.com") {
  ...
  _addtocartdialog(int index) {
    ...
    if (widget.user.email == "admin@bakery.com") {
      Toast.show("Admin Mode!!!", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
